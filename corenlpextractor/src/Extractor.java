...
public class Extractor {
  ...
  public Map getEntities(String question){
    ...
    props1.put("ner.model", "/home/abilashini/Desktop/Link to Final Year Project/corenlpextractor/ner-all.ser.gz");
    StanfordCoreNLP pipelineAll = new StanfordCoreNLP(props1);

    NGramTokenizer tokenizer = new NGramTokenizer();
    String modelTokens = tokenizer.tokenize(question);

    Annotation documentModel = new Annotation(modelTokens.toString());
    pipelineAll.annotate(documentModel);
