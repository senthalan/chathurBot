...
def generate(response):
    query_template = u"SELECT DISTINCT {function}({column_name}) FROM electronics {where_expression} {order_expression}"
    entities_list = {}
    intent = ''
    select = ''
    equality = ''
    ...
    final_query = query_template.format(function=max_min, column_name=select, where_expression=where_part,
